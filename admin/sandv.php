...
if(isset($_POST['search']))
{
    ...
    {
        $message='<b style="color:rgba(256,0,0,1);"><i class="fa fa-warning"> </i> Enter the Register number in search box to view</b>';
    }
    else
    {
        $qry="select * from stregister where regno='".$sroll."'";
        $rslt=$con->query($qry);
        if($rslt->num_rows<=0)//finding the student
        {
            $message='<b style="color:rgba(256,0,0,1);"><i class="fas fa-warning"> </i> Student with that Register number not found</b>';
        }
        else
        {   
            ...
            $qry1="select * from payment where email='".$regemail."'";
            $rslt1=$con->query($qry1);
...
<head>
    ...
    <link rel="stylesheet" href="sandv.css">
...
<div class="search">
   <input type="text" name="sroll" placeholder="SEARCH REGISTER NO" oninput="vInput(event)" autocomplete="off">
    ...
    <!-- <form action=""> -->
        ...
        <div class="eq">
            ...
            <input class="fname" type="text" value="<?php echo $course; ?>" readonly placeholder="COURSE" name="course" >
                ...
                <input class="fname" type="text" value="<?php echo $student_status; ?>" readonly placeholder="STUDENT STATUS" name="st_status" >
        ...
        <div class="ad">
            <div class="adalign">
                    ...
                    <input class="fname" type="text" value="<?php echo $fees; ?>" readonly placeholder="PAYMENT DONE" name="fees" >
